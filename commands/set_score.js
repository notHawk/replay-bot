...
module.exports.run = async (bot, message, args) => {
      ...
      message.delete();
      message.channel.send({embed:{description:"You've set "+mention.username+"'s points to "+adding_value}});
      console.log(`${message.author.username} has used the set score command`);
      return;
